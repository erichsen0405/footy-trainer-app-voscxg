  ...
  it('maps task_template_self_feedback row to view model', () => {
    const mapped = mapFeedbackRow({
      ...
      task_templates: {
        ...
        description: 'Orienter dig inden modtagelse',
        after_training_feedback_score_explanation: 'Hvor ofte lykkedes det?',
      },
    ...
    expect(mapped).toEqual({
      ...
      taskTemplateDescription: 'Orienter dig inden modtagelse',
      taskTemplateScoreExplanation: 'Hvor ofte lykkedes det?',
      taskInstanceId: null,
      activityId: 'a1',
      rating: 4,
      note: 'solid',

-- Fix mojibake in feedback task titles/descriptions and update the helper function
-- generated by 20260205123000_internal_feedback_reminder_minutes.sql.
-- Safe to rerun: uses CREATE OR REPLACE and targeted UPDATE filters.
...
-- Correct already-created rows that contain the garbled text
update public.activity_tasks

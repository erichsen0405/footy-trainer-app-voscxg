-- Owner-aware platform admin list for Base44 and other admin surfaces.
...
comment on function public.list_platform_admin_owner_accounts(uuid) is
  'Returns all owner accounts with effective seat status for platform admins through service-backed Edge Functions, bypassing browser RLS limits safely.';

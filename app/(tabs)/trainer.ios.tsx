        ...
        <View style={styles.header}>
          <View style={[styles.headerCard, { backgroundColor: colors.primary }]}>
            <IconSymbol
              ...
              color="#fff"
            />
            <Text style={styles.headerTitle}>Træner Panel</Text>
            <Text style={styles.headerSubtitle}>Administrer teams, spillere og indstillinger</Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  scrollView: { flex: 1 },
  scrollContent: { paddingTop: Platform.OS === 'android' ? 60 : 20, paddingHorizontal: 20 },
  ...
  headerSubtitle: { fontSize: 16, color: '#fff', opacity: 0.9, textAlign: 'center' },
  ...
  sectionDescription: { fontSize: 15, lineHeight: 22, marginBottom: 20 },
  addButton: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 6,

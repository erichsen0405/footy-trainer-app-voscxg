  ...
  try {
    ...
    if (!internalError && internalActivity) {
      ...
      const category: ActivityCategory = {
        ...
        emoji: internalActivityAny.activity_categories?.emoji || 'ﯙ',
      };
    ...
    console.error('ﯔ Error fetching activity from database:', error);
    return null;
  }
}
...
function ActivityDetailsContent(props: ActivityDetailsContentProps) {
  ...
  const renderListHeader = useCallback(() => {
    const selectableCategories = Array.isArray(categories) ? categories : [];
              ...
              return (
                <TouchableOpacity
                  ...
                  style={[
                    styles.categoryChip,
                    {
                      backgroundColor: isSelected ? colors.primary : fieldBackgroundColor,
                      borderWidth: 1,
